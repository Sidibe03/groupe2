...
image1=PhotoImage(file="C:\\Users\\Admin\\PycharmProjects\\bigstock\\ouvert.png")
x=Label(cadre,image=image1)
image2=PhotoImage(file="C:\\Users\\Admin\\PycharmProjects\\bigstock\\ferme.png")
...
pad= customtkinter.CTkButton(master=cadre,text="Créer un compte",text_font=('Italic',11),command=quit,
